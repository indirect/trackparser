...
to spinOff(faves, lst)
	...
	set pTB to (path to "dlib" from user domain as string) & "iTunes:Scripts"
...
to getStandaloneScript(thePat, theSrc)
	script scpt
		...
		-- You can find this, and other scripts, at
			...
			if src = "SN" then
				...
				tell application "iTunes"
					...
					repeat with i from 1 to num
						set song to item i of sel
						set trackName to song's name
						my applyPattern(trackName, cPat, song, callback)
